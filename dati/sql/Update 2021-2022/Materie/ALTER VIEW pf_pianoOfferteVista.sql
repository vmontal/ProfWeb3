...
/****** Object:  View [dbo].[pf_pianoOfferteVista]    Script Date: 08/09/2021 18:16:19 ******/
SET ANSI_NULLS ON
GO
...
SELECT dbo.pf_parSedi.idRS, dbo.pf_pianoOfferte.idSede, dbo.pf_pianoOfferte.idOfferta, dbo.pf_pianoOfferte.idLezione, dbo.pf_pianoOfferte.idProfessore, dbo.pf_anagrafeProfessoriVista.nomeProf, dbo.pf_anagrafeProfessoriVista.emailProf, 
                  ...
                  dbo.pf_anagrafeStudentiVista.special, dbo.pf_pianoOfferte.distanza, dbo.pf_anagrafeProfessoriVista.modoLezione
FROM     dbo.pf_parOrariVista RIGHT OUTER JOIN
                  ...
                  dbo.pf_anagrafeProfessoriVista ON dbo.pf_pianoOfferte.idProfessore = dbo.pf_anagrafeProfessoriVista.idProfessore ON dbo.pf_parOrariVista.idOrario = dbo.pf_pianoOfferte.idOrario AND 
                  dbo.pf_parOrariVista.idSede = dbo.pf_pianoOfferte.idSede LEFT OUTER JOIN
